...
public class StickyItemDecoration extends RecyclerView.ItemDecoration {
     ...
     * 通过它获取到需要吸附view的相关信息
     */
    private StickyViewListener mStickyViewListener;
    ...
    public StickyItemDecoration(StickyViewListener stickyViewListener) {
        this.mStickyViewListener = stickyViewListener;
        initPaint();
    }
    ...
    public void onDrawOver(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        for (int m = 0, size = parent.getChildCount(); m < size; m++) {
             ...
             * 如果是吸附的view
             */
            if (mStickyViewListener.isStickyView(view)) {
    ...
    private void getStickyViewHolder(RecyclerView recyclerView) {
        ...
        mViewHolder = mAdapter.onCreateViewHolder(recyclerView, mStickyViewListener.getStickViewType());
