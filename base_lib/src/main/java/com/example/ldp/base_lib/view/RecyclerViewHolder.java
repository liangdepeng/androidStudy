...
public class RecyclerViewHolder extends RecyclerView.ViewHolder {
     ...
     */
    public RecyclerViewHolder setText(int viewId, @StringRes int stringResId) {
    ...
    public RecyclerViewHolder setText(int viewId, CharSequence text, int colorId) {
        return setText(viewId, text, -1, colorId);
    }

    private RecyclerViewHolder setText(int viewId, CharSequence text, @StringRes int stringResId, int colorId) {
    ...
    public RecyclerViewHolder setTextColor(int viewId, int colorId) {
        TextView textView = getView(viewId);
        textView.setTextColor(colorId);
        return this;
    }
     ...
     */
    public RecyclerViewHolder setTextGravity(int viewId, int gravity) {
        TextView textView = getView(viewId);
     ...
     */
    public RecyclerViewHolder setImagineLocalRes(int viewId, int resId) {
        ImageView view = getView(viewId);
        view.setImageResource(resId);
        return this;
    }

    public RecyclerViewHolder setImagineDrawable(int viewId, Drawable drawable) {
     ...
     */
    public RecyclerViewHolder setViewBackgroundRes(int viewId, int resId) {
        View view = getView(viewId);
     ...
     */
    public RecyclerViewHolder setViewBackgroundDrawable(int viewId, Drawable background) {
        View view = getView(viewId);
     ...
     * @return this
     */
    public RecyclerViewHolder setImagineAlpha(int viewId, int alpha) {
     ...
     */
    public RecyclerViewHolder setViewAlpha(int viewId, float alpha) {
        View view = getView(viewId);
        view.setAlpha(alpha);
        return this;
    }
     ...
     */
    public RecyclerViewHolder setViewBackgroundColor(int viewId, int colorId) {
        View view = getView(viewId);
     ...
     */
    public RecyclerViewHolder setViewEnabled(int viewId, boolean isEnabled) {
        View view = getView(viewId);
        view.setEnabled(isEnabled);
        return this;
    }

    public RecyclerViewHolder setImagineByNetUrl(Context context, int viewId, String netResUrl, int placeholder) {
        ImageView imageView = getView(viewId);
